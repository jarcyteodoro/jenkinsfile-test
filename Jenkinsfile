     ...
     stages {
          ...
          stage('Upload Artifact/s to Nexus') {
               steps {
                    ...
                    sh label: 'Uploading to Nexus', script: 'curl -v -u admin:admin123 --upload-file target/calculator-unit-test-example-java-1.0-SNAPSHOT.jar http://nexus:8081/repository/maven-releases/Sample-Java-Project/'
               }
          }
    }
}
