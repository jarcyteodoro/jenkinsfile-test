pipeline {
     ...
     stages {
          ...
          stage('Build, JUnit and JaCoCo') { 
               steps {
                    echo "Building..."
                    sh 'mvn clean test surefire-report:report org.jacoco:jacoco-maven-plugin:0.8.2:prepare-agent org.jacoco:jacoco-maven-plugin:0.8.2:report install package' 
               }
          }
